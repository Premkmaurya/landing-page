...
const App = () => {
  const projects = [
    ...
    {
      imgTitle: "louises-phone",
      small: "design",
      title: "Louise's Phone",
    },
    {
      imgTitle: "kikk-festival-2018",
      small: "design",
      title: "KIKK Festival 2018",
    },
    {
      imgTitle: "the-kennedy-center",
      small: "design",
      title: "The Kennedy Center",
    },
    {
      imgTitle: "royal-opera",
      small: "design",
      title: "Royal opera",
    },
  ];
        ...
        <section id="section-1">
          ...
          <div className="bottom">
            ...
            <div className="right-section">
              <h2>
                Dogstudio is a multisciplinary creative studio at the
                ...
                {[
                  ...
                  return (
                    <>
                      ...
                      {idx !== 4 && <span className="divider">|</span>}
                    </>
                  );
                })}
              </p>
        ...
        <section id="section-2">
          ...
          <div className="projects">
            {projects.map((project, idx) => {
              return (
                <div img-title={project.imgTitle} className="project" key={idx}>
